...
?>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="pics/Halo_Reach_1680%20x%201050%20widescreen.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img src="pics/True_Crime_Hong_Kong_1680%20x%201050%20widescreen.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img src="pics/The_Witcher_Rise_of_the_White_Wolf_1680%20x%201050%20widescreen.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="pics/ipad-design.png" alt="Generic placeholder image">
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="pics/apple-ipad-3.jpg" alt="Generic placeholder image">
        </div>
        <div class="col-md-7">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="pics/apple-iphone-3g-black.jpg" alt="Generic placeholder image">
        </div>
      </div>
	...
	<?php
		...
		if ($user->isLoggedIn()) {
			?>
			<p>
				Hello <a href="profile.php?user=<?php echo escape($user->data()->username); ?>"><?php echo escape($user->data()->username); ?> </a>! 
			</p>
