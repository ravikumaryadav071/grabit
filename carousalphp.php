...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="///bootstrap/jquery/smoothness/jquery-ui-1.10.1.custom.min.css" />
    ...
    <script type="text/javascript" src="///../bootstrap-3.2.0/docs/dist/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="///../bootstrap-3.2.0/docs/assets/js/docs.min.js"></script>
  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="pics/apple-ipad-3.jpg" data-src="holder.js/500x500/auto" alt="Generic placeholder image">
        </div>
      </div>
